...
function createHeaderRow() {
    ...
    nameHeader.innerHTML = "<a class='header-button name-btn'>Name</a>";
    jerseyNumberHeader.innerHTML = "<a class='header-button jn-btn'>Jersey Number</a>";
    ageHeader.innerHTML = "<a class='header-button age-btn'>Age</a>";
    positionHeader.innerHTML = "<a class='header-button pos-btn'>Position</a>";
    nationalityHeader.innerHTML = "<a class='header-button nation-btn'>Nationality</a>";
