...
//               rankCell.innerHTML = `<div class="ranking${rank}">${rank}</div>`;
//               teamCell.innerHTML = `<div class="team container"><a class="logo-team" href="/teams/${teamName}"><img src="../../team-icons/${teamLogoSrc}" alt="${teamName}"></a><a class="name-team" href="/teams/${teamName}">${teamName}</a></div>`;
//               matchesCell.textContent = matches;
//               winsCell.textContent = wins;
//               drawsCell.textContent = draws;
//               losesCell.textContent = loses;
